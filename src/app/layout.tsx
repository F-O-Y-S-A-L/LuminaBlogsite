          ...
          <footer className="border-t border-slate-200 py-20 bg-white">
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-10">
              <div className="flex flex-col gap-2">
                <span className="text-2xl font-outfit font-black tracking-tighter text-indigo-600">LUMINA.</span>
                <p className="text-sm text-slate-400 max-w-xs">Connecting digital minds through high-quality narratives.</p>
              </div>
              <div className="flex space-x-10 text-sm font-semibold text-slate-500">
                <Link href="/" className="hover:text-indigo-600 transition-colors">Archive</Link>
                <Link href="/login" className="hover:text-indigo-600 transition-colors">Access</Link>
                <a href="#" className="hover:text-indigo-600 transition-colors">Terms</a>
                <a href="#" className="hover:text-indigo-600 transition-colors">Privacy</a>
              </div>
              <p className="text-xs text-slate-300 font-medium">© 2026 Lumina Platform.</p>
            </div>
          </footer>
        </AuthProvider>
      </body>
